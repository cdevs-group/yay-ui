...
var BridgeWidgetStep = function (_a) {
    ...
    return (React__default['default'].createElement(BridgeWrapper, null,
        ...
        React__default['default'].createElement(InputWrap, null,
            React__default['default'].createElement(BalanceInput, { onUserInput: onUserInputWrite, value: value, icon: iconBalanceInput, texts: { commit: texts.commit, currency: texts.currency } })),
