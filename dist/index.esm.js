...
var ClaimBlock = function (_a) {
    ...
    return (React__default.createElement(Card, { src: BG },
        ...
        React__default.createElement(StyledButton, { endIcon: endIcon, isLoading: !!endIcon && isLoading, disabled: !canClaim || !!endIcon, variant: canClaim ? "green" : "option" }, text.button)));
};
...
var StakingDashboard = function (_a) {
    ...
    return (React__default.createElement(Wrapper, null,
        ...
        React__default.createElement(ClaimBlock, { endIcon: endIconButtonClaimBlock, onClick: handleClaimBlock, canClaim: canClaim, text: textClaimBlock }),
        React__default.createElement(MarketplaceLink, { text: textMarketplaceLink, link: linkMarketplace, images: imagesMarketplace })));
};
