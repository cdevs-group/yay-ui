...
var useWalletModal = function (login, logout, account, textsAccount, textConnect) {
    var textsAccountDefault = {
        copy: "Copy",
        title: "Your wallet",
        button: "Logout",
        view: "View on BscScan",
    };
    var textConnectDefault = {
        title: "Сonnect wallet",
        link: "Learn how connect",
    };
    var onPresentConnectModal = useModal(React__default.createElement(ConnectModal, { texts: textConnect || textConnectDefault, login: login }))[0];
    var onPresentAccountModal = useModal(React__default.createElement(AccountModal, { texts: textsAccount || textsAccountDefault, account: account || "", logout: logout }))[0];
...
var Header = function (_a) {
    var account = _a.account, login = _a.login, logout = _a.logout; _a.isDark; _a.toggleTheme; var langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, links = _a.links, textConnect = _a.textConnect;
        ...
        React__default.createElement(Line, null,
            ...
            React__default.createElement(RightContent, null,
                React__default.createElement(LanguageBlockDesk, null,
                    React__default.createElement(Languages, { currentLang: currentLang, setLang: setLang, langs: langs })),
                React__default.createElement(Account, { text: textConnect || "Connect", account: account, login: login, logout: logout }),
