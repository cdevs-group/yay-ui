...
var AccountVestingModal = function (_a) {
    var texts = _a.texts, account = _a.account, logout = _a.logout, yayBalance = _a.yayBalance, dataTransactions = _a.dataTransactions, _b = _a.handleClaimed, handleClaimed = _b === void 0 ? function () { return null; } : _b, _c = _a.onDismiss, onDismiss = _c === void 0 ? function () { return null; } : _c, handleAddToken = _a.handleAddToken;
    ...
    return (React__default.createElement(Modal, { title: texts.title, onDismiss: onDismiss },
        React__default.createElement(ModalWrap, null,
            ...
            tabValue === 0 && (React__default.createElement(React__default.Fragment, null,
                React__default.createElement(Text, { letterSpacing: "-0.02em", color: "textGray", marginBottom: "7px", fontSize: "14px", lineHeight: "24px", marginTop: "37px", fontWeight: "400" }, texts.address),
                React__default.createElement(Text, { bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" } },
                ...
                React__default.createElement(Flex, { justifyContent: "center" },
                    React__default.createElement(Button$9, { scale: "md", width: "100%", variant: "secondary", style: { fontWeight: 400 }, onClick: function () {
                            logout();
                            window.localStorage.removeItem(connectorLocalStorageKey);
                            onDismiss();
                        } }, texts.button)))),
...
var useWalletModal = function (login, logout, textsAccount, textsConnect, network, account, hrefLearnHow, vesting, yayBalance, dataTransactions, handleClaimed, bridge, textsBridge, transactionsList, handleAddToken) {
    var pageModal = function () {
        if (vesting) {
            return (React__default.createElement(AccountVestingModal, { texts: textsAccount, account: account || "", logout: logout, yayBalance: yayBalance, dataTransactions: dataTransactions, handleClaimed: handleClaimed, handleAddToken: handleAddToken }));
        }
        else if (bridge) {
