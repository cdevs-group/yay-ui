...
function MyTimer$1(_a) {
    ...
    return (React__default.createElement(Wrap$l, null,
        React__default.createElement(Block$6, { color: color }, timeArray.map(function (item, i) { return (React__default.createElement(React__default.Fragment, { key: "item-" + i },
...
var TimerNotSolid = function (_a) {
    ...
    return (React__default.createElement("div", null, (time || time === 0) && !isLoad ? React__default.createElement(MyTimer$1, { expiryTimestamp: time, color: color || "text" }) : React__default.createElement(LoadingTimer, null)));
};
    ...
    return (React__default.createElement(Wrapper$8, null,
        React__default.createElement(BlocksAndTimer, null,
            ...
            React__default.createElement(Timer, null,
                React__default.createElement("p", null, "\u2248"),
                " ",
                React__default.createElement("p", null, hour),
                ":",
                React__default.createElement("p", null, min),
                ":",
                React__default.createElement("p", null, sec)),
            React__default.createElement(Block$4, null,
...
var Indicator = styled.div(templateObject_6$f || (templateObject_6$f = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n  height: 8px;\n  margin-bottom: 13px;\n  background: ", ";\n  //box-shadow: ", ";\n  border-radius: 6px;\n  &:after {\n    display: block;\n    content: \"\";\n    position: absolute;\n    width: calc(100% - 5px);\n    height: 100%;\n    top: 0;\n    left: 0;\n    background: ", ";\n    border-radius: 2px;\n    width: ", ";\n    box-shadow: ", ";\n    border-radius: 6px;\n  }\n"], ["\n  position: relative;\n  width: 100%;\n  height: 8px;\n  margin-bottom: 13px;\n  background: ", ";\n  //box-shadow: ", ";\n  border-radius: 6px;\n  &:after {\n    display: block;\n    content: \"\";\n    position: absolute;\n    width: calc(100% - 5px);\n    height: 100%;\n    top: 0;\n    left: 0;\n    background: ", ";\n    border-radius: 2px;\n    width: ", ";\n    box-shadow: ", ";\n    border-radius: 6px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Note = styled.div(templateObject_7$6 || (templateObject_7$6 = __makeTemplateObject(["\n  display: ", ";\n  position: relative;\n  width: 100%;\n  padding: 12px 57px 12px 20px;\n  box-sizing: border-box;\n  background: ", ";\n  border-radius: 12px;\n"], ["\n  display: ", ";\n  position: relative;\n  width: 100%;\n  padding: 12px 57px 12px 20px;\n  box-sizing: border-box;\n  background: ", ";\n  border-radius: 12px;\n"])), function (_a) {
    var open = _a.open;
...
var CloseButton = styled.button(templateObject_8$2 || (templateObject_8$2 = __makeTemplateObject(["\n  border: none;\n  background: none;\n  padding: 0;\n  position: absolute;\n  right: 12px;\n  top: 50%;\n  cursor: pointer;\n  transform: translateY(-50%);\n"], ["\n  border: none;\n  background: none;\n  padding: 0;\n  position: absolute;\n  right: 12px;\n  top: 50%;\n  cursor: pointer;\n  transform: translateY(-50%);\n"])));
