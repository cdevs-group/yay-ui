...
var Button$9 = function (props) {
    ...
    return (React__default.createElement(StyledButton$5, __assign({ "$isLoading": isLoading, className: classNames.join(" "), disabled: isDisabled }, rest),
        React__default.createElement(React__default.Fragment, null,
            ...
            children,
            props.spin ? React__default.createElement(Icon$v, { spin: true, fill: "rgba(0,0,0,0)" }) : null,
                ...
                React__default.createElement(UpContent$1, { negative: negative, showUp: showBtnWinnings, colorNone: colorNone, displayNone: displayNone },
                    ...
                    React__default.createElement(RightText$3, { displayNone: displayNone },
                        ...
                        React__default.createElement(IconComplete$3, { className: "completeIcon", showIcon: hasEnteredUp },
                            React__default.createElement(Icon$w, { fill: "#FFB72C" })))),
    ...
    return (React__default.createElement(Wrap$v, null,
        ...
        React__default.createElement(Line$a, null,
            React__default.createElement(Arrow$4, { negative: negative },
                React__default.createElement(Icon$r, { color: negative ? "#FF6161" : "#4AE43D" })),
...
var LinkExternal = function (_a) {
    ...
    return (React__default.createElement(Link$2, __assign({ external: true }, props),
        children,
        icon || React__default.createElement(Icon$O, { ml: "4px" })));
};
...
var LoadIcons$1 = [React__default.createElement(Icon$v, { spin: true, fill: "none" }), React__default.createElement(Icon$v, { spin: true, fill: "none" }), React__default.createElement(Icon$v, { spin: true, fill: "none" })];
...
var getIcon = function (variant) {
    ...
    switch (variant) {
        case variants$1.COLLECTION:
            return React__default.createElement(Icon$v, { spin: true });
        case variants$1.WINNING:
            return React__default.createElement(Icon$R, null);
        case variants$1.SUCCESS:
            return React__default.createElement(Icon$w, { fill: "#47DA3B" });
        case variants$1.INFO:
            return React__default.createElement(React__default.Fragment, null);
        case variants$1.ERROR:
            return React__default.createElement(Icon$i, null);
        default:
            return React__default.createElement(React__default.Fragment, null);
    }
};
...
var SetButton = function (_a) {
    ...
    return (React__default.createElement(Button$8, { disabled: variant !== "winning", onClick: onClick }, Icon));
};
        ...
        React__default.createElement("div", null,
            React__default.createElement(Flex, { justifyContent: "space-between" },
                ...
                React__default.createElement(ButtonClose$3, { onClick: handleClose },
                    React__default.createElement(Icon$R, { fill: "none" }))),
            React__default.createElement("div", null, children),
            React__default.createElement(ButtonNext, { height: "auto", onClick: onClick },
                buttonText,
                React__default.createElement(Icon$J, { color: "#4BE43E" })))));
};
...
var InputSearch = function (_a) {
    ...
    return (React__default.createElement(InputBlock$1, { height: height, width: width },
        ...
        React__default.createElement(Button$7, { iconLess: iconLess },
            React__default.createElement(Icon$G, { color: focus ? "green" : "text" }))));
};
    ...
    return (React__default.createElement(BottomContent$1, null,
        React__default.createElement(CenterBlock, null,
            React__default.createElement(ArrowLeft, { className: clsNameLeft || "", onClick: handlePrevSlide },
                React__default.createElement(Icon$J, { stroke: "#47DA3B" })),
...
var LoadIcons = [React__default.createElement(Icon$v, { spin: true, fill: "none" }), React__default.createElement(Icon$v, { spin: true, fill: "none" }), React__default.createElement(Icon$v, { spin: true, fill: "none" })];
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        icon || React__default.createElement(Icon$I, { width: "20px", color: "#47DA3B", ml: "4px" }),
        ...
        React__default.createElement(ModalWrap, { minHeight: minHeight },
            ...
            tabValue === 0 && (React__default.createElement(React__default.Fragment, null,
                ...
                React__default.createElement(Text, { bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" } },
                    React__default.createElement(AccountWrap, { as: "div" },
                        ...
                        React__default.createElement(CopyText, { color: "#47DA3B" },
                            React__default.createElement(CopyToClipboard, { toCopy: account, textCopied: texts.copied, icon: React__default.createElement(Icon$b, null), left: "auto" })))),
                ...
                React__default.createElement(Flex, { mb: "30px" },
                    React__default.createElement(LinkExternal, { color: "#47DA3B", small: true, href: linkExternalWalletModal || "https://bscscan.com/address/" + account, mr: "16px", icon: React__default.createElement(Icon$c, { style: { marginLeft: 5 } }), style: { fontWeight: 400 } }, texts.view)),
                React__default.createElement(Flex, { justifyContent: "center" },
            ...
            tabValue === 1 && (React__default.createElement(React__default.Fragment, null,
                ...
                (dataTransactions === null || dataTransactions === void 0 ? void 0 : dataTransactions.length) ? (React__default.createElement(Table$3, null, dataTransactions === null || dataTransactions === void 0 ? void 0 : dataTransactions.map(function (el, i) { return (React__default.createElement(React__default.Fragment, { key: el.id + "-" + i },
                    ...
                    React__default.createElement(ButtonClaimed, { onClick: function () { return handleClaimed(el.id); } },
                        texts.claimed,
                        React__default.createElement(Icon$c, { stroke: "#fff", style: { marginLeft: 5 }, width: "8px" })),
    ...
    return (React__default.createElement(Panel, { open: isHistoryPaneOpen },
        React__default.createElement(Wrap$d, null,
            React__default.createElement(ButtonToggle, { onClick: handleToggle, open: isHistoryPaneOpen, color: valueAccordeon ? "dark" : "panel" },
                React__default.createElement(Icon$z, { className: "button" }),
                React__default.createElement(Icon$A, { className: "arrow" })),
            children)));
};
        ...
        React__default.createElement(Wrap$b, null,
            ...
            React__default.createElement("a", { href: href },
                React__default.createElement(ButtonBlock, { width: "100%", variant: "green", scale: "md" },
                    ...
                    " \u00A0",
                    React__default.createElement(Icon$O, { fill: "rgba(0,0,0,0)" }))))));
};
        ...
        React__default.createElement("div", { key: item.id },
            React__default.createElement(Card$4, { onClick: function () { return handleToggle(item); }, className: active && active.id === item.id && valueAccordeon ? "active" : "" },
                ...
                React__default.createElement(Flex, { alignItems: "center", justifyContent: "flex-end" },
                    betLabel,
                    icon || React__default.createElement(Icon$l, null))),
...
var Disclaimer = function (_a) {
    ...
    return (React__default.createElement(Block$4, { open: open },
        ...
        React__default.createElement(Button$1, { onClick: function () { return setOpen(false); } },
            React__default.createElement(Icon$Q, { role: "button" }))));
};
    ...
    return (React__default.createElement(Wrapper$9, null,
        ...
        React__default.createElement(BottomContent, null, players ? (React__default.createElement(React__default.Fragment, null,
            React__default.createElement(Buttons$2, null,
                ...
                React__default.createElement(Icon$h, { role: "button", onClick: handleShare })),
...
var CollectRoundWinningsModal = function (_a) {
    ...
    return (React__default.createElement(Modal, { title: title, onDismiss: onDismiss },
        ...
        React__default.createElement(Box, { padding: "20px" },
            ...
            React__default.createElement(Button$9, { width: "100%", mb: "8px", onClick: handleClick, isLoading: isLoading, endIcon: isLoading ? React__default.createElement(Icon$v, { spin: true, fill: "none" }) : null, variant: "green" }, buttonText))));
};
