...
declare const CardProduct: ({ title, img, bg, closed, href, externalLink, isNotLink, small, ...props }: CardProductProp) => JSX.Element;
export default CardProduct;
export declare const CardWrap: import("styled-components").StyledComponent<"div", import("styled-components").DefaultTheme, {
