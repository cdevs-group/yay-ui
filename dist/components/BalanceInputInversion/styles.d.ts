...
export declare const StyledBalanceInput: import("styled-components").StyledComponent<"div", import("styled-components").DefaultTheme, import("../Box").BoxProps & {
    isWarning: BalanceInputInversionProps["isWarning"];
}, never>;
export declare const StyledInput: import("styled-components").StyledComponent<"input", import("styled-components").DefaultTheme, import("../Input/Input").StyledInputProps & {
