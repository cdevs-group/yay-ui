...
import BalanceInput from "../../components/BalanceInputInversion/BalanceInputInversion";
...
export const ThemeInversion: React.FC = () => {
  const tooltipContent = (
    <>
      ...
      <Toggle />
      <BalanceInput value="1.0" currencyValue="~623.45 USD" placeholder="0.0" onUserInput={() => {}} />
    </>
  );
