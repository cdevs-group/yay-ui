  ...
  return (
    <Svg width='42px' viewBox="0 0 42 42" {...props}>
      ...
      <g filter="url(#filter0_d)">
        <path fill={props.fill || 'rgba(0,0,0,0)'} d="M22.6237 15C25.1545 15.7532 27 18.0977 27 20.8731C27 24.2569 24.2569 27 20.8731 27C18.0977 27 15.7532 25.1545 15 22.6237" stroke="white" strokeWidth="1.8" strokeLinecap="round" />
      </g>
      <defs>
        <filter id="filter0_d" x="10.0996" y="12.0997" width="21.8002" height="21.8002" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
