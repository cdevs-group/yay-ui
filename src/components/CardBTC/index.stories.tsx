  ...
  return (
    <div style={{ padding: "32px", width: "500px" }}>
      <CardBTC
        ...
        time={2000}
      >
        <ExpiredCardBTC clodedBTC="400'597" lockedBTC="3200" closedETH="25'100" lockedETH="1200" prize="0'005" />
      </CardBTC>
    </div>
  );
};
  ...
  return (
    <div style={{ padding: "32px", width: "500px" }}>
      <CardBTC leftContent="EXPIRED" rightContent="#001" payoutUp={1.03} payoutDown={5.03} time={2000}>
        <ExpiredCardBTC clodedBTC="400'597" lockedBTC="3200" closedETH="25'100" lockedETH="1200" prize="0'005" btc />
      </CardBTC>
    </div>
  );
};
  ...
  return (
    <div style={{ padding: "32px", width: "500px" }}>
      <CardBTC live negative leftContent="LIVE" rightContent="#001" payoutUp={1.03} payoutDown={5.03} time={2000}>
        <LiveCardBTC clodedBTC="400'597" lockedBTC="3200" closedETH="25'100" lockedETH="1200" prize="0'005" />
      </CardBTC>
    </div>
  );
};
